                ...
                <>
                        ...
                        <div className="group relative bg-[#111114] border border-white/5 rounded-[3.5rem] p-10 overflow-hidden flex flex-col lg:flex-row items-center gap-12 transition-all hover:border-blue-500/30 shadow-2xl">
                            ...
                            <div className="flex-1 space-y-8 text-left">
                                ...
                                <div className="bg-black/40 p-6 rounded-3xl border border-white/5 space-y-4">
                                    <p className="text-sm text-gray-400 leading-relaxed font-medium italic">Menú Omakase de 12 pasos + Maridaje. Mínimo 2 pers.</p>
                    ...
                    <section className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <CuratedCard icon={<Heart size={28} className="text-red-500" />} title="Velada Intima" subtitle="Plan Romántico" details="Mesa en zona tranquila, carta de vinos, postre compartido y ambiente bajo." color="hover:border-red-500/30" />
                            <CuratedCard icon={<Briefcase size={28} className="text-blue-500" />} title="Ejecutivo & Networking" subtitle="Plan Negocios" details="Menú ejecutivo, conexión WiFi, área de bar para charlar y cócteles rápidos." color="hover:border-blue-500/30" />
                            <CuratedCard icon={<UtensilsCrossed size={28} className="text-green-500" />} title="Omakase Express" subtitle="Plan Foodie Lover" details="Degustación de 7 tiempos en barra chef, sake pairing y sorpresa del chef." color="hover:border-green-500/30" />
                        </div>
                    </section>
                </>
            ) : (
            ...
            <section className="relative">
                <div className="bg-[#111114] border border-white/5 p-8 md:p-16 rounded-[4rem] flex flex-col items-center justify-center text-center shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10 space-y-8 max-w-xl animate-in fade-in zoom-in duration-700">
                        ...
                        <button onClick={() => setShowConcierge(true)} className="bg-white text-black hover:bg-blue-600 hover:text-white px-12 py-5 rounded-[2.5rem] font-black italic text-xs uppercase tracking-[0.2em] transition-all shadow-2xl flex items-center gap-4 mx-auto group active:scale-95">
...
const CuratedCard: React.FC<CuratedCardProps> = ({ icon, title, subtitle, details, color }) => (
